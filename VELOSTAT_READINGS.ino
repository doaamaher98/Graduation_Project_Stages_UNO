...
/* Flex (1) : THUMB */
const float flatResistance1 = 2300.0;	// resistance when flat
const float bendResistance1 = 5100.0;	// resistance at 90 deg
int flex1Pin = A0;
/*********************************************************************/
/* Flex (2) : Index */
const float flatResistance2 = 4500.0;	// resistance when flat
const float bendResistance2 = 3900.0;	// resistance at 90 deg
int flex2Pin = A1;
/*********************************************************************/
/* Flex (3) : Middle */
const float flatResistance3 = 2000.0;	// resistance when flat
const float bendResistance3 = 1050.0;	// resistance at 90 deg
int flex3Pin = A2;
/*********************************************************************/
/* Flex (4) : Ring */
const float flatResistance4 = 7000.0;	// resistance when flat
const float bendResistance4 = 4000.0;	// resistance at 90 deg
int flex4Pin = A3;
/*********************************************************************/
/* Flex (5) : Ring */
const float flatResistance5 = 4000.0;	// resistance when flat
const float bendResistance5 = 2520.0;	// resistance at 90 deg
int flex5Pin = A4;
...
/*********************************************************************/
  ...
  // Read the ADC from INDEX, and calculate voltage and resistance from it
	...
	float Vflex2 = ADCflex1 * VCC / 1023.0;
